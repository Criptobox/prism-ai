...
const TINTS: Record<SlashId, string> = {
  ...
  email: "bg-emerald-500/12 text-emerald-600 dark:text-emerald-400",
  carrusel: "bg-prism-pink/12 text-prism-pink",
  poster: "bg-amber-500/12 text-amber-600 dark:text-amber-400",
