...
## v3.32.0 — Plan V7: herramientas del agente + HUD + aurora
...
## v3.33.0 — Plan V7 (2ª tanda): pestañas, bienvenida y aurora glass
...
## v3.34.0 — Plan V7 (3ª tanda): U2 snippets + U3 plantillas + U4 wrapped + U6 presentación
...
## v3.34.1 — SparkleAvatar + Sandbox abre index.html directo
...
## v3.34.2 — Avatar sin contenedor + degradado del tema en el fondo del chat
...
## v3.34.3 — Logo más visible + code block sin scroll + pulido
...
## v3.34.3 — Logo rediseñado + contenedor de código que envuelve de verdad
